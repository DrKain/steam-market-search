...
var SteamMarket = /** @class */ (function () {
    ...
    SteamMarket.prototype.getQuery = function (options) {
        ...
        return this.querystring(__assign(__assign({ start: 0, count: 50, search_descriptions: 0, sort_column: 'price', sort_dir: 'desc', game_appid: null, norender: 1 }, this.defaults), options));
    };
    /**
